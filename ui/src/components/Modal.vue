<template>
  ...
  >
    <div
      class="relative bg-white w-full max-w-md m-auto flex-col flex rounded shadow-md min-h-half-screen"
      @click.stop=""
    >
      <h1
        v-if="title"
        class="mb-4 px-4 py-3 text-lg text-black bg-offwhite rounded-t"
        v-html="title"
      />
      <div class="py-4 px-8 mb-16 overflow-auto max-h-70-screen">
        <div v-if="content" class="text-sm leading-normal" v-html="content" />
