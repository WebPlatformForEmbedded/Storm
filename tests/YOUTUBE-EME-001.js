...
module.exports = {
    ...
    'steps'         : {
       'step1' : {
        ...
        'step5' : {
            'description'   : 'Set the EME 2016 URL',
            'test'          : setUrl,
            'params'        : 'http://yt-dash-mse-test.commondatastorage.googleapis.com/unit-tests/2016.html?test_type=encryptedmedia-test&enablewebm=off',
            'validate'      : httpResponseSimple
        },
        'step6' : {
