...
function Stage(options) {
    this.adapter = options.adapter || (WebAdapter ? new WebAdapter() : null);

    if (!this.adapter && WebAdapter) {
        // Default is web-based.
    ...
    this.setGlClearColor((options && options.glClearColor) || this.adapter.glClearColor || [0, 0, 0, 0]);
     ...
     * @type {TextureAtlas}
     */
    this.textureAtlas = new TextureAtlas(this, this.renderer.gl);
    ...
    this.root.uComponent.setAsRoot();
