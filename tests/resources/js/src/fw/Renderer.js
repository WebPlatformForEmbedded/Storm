...
Renderer.prototype.initShaderProgram = function() {
    ...
    this.paramsGlBuffer[0] = gl.createBuffer();
    this.paramsGlBuffer[1] = gl.createBuffer();
    this.paramsGlBuffer[2] = gl.createBuffer();
    this.paramsGlBuffer[3] = gl.createBuffer();
...
Renderer.prototype.renderItems = function() {
    ...
    gl.bindBuffer(gl.ARRAY_BUFFER, this.paramsGlBuffer[this.stage.frameCounter % 4]);
