...
function Transition(value, mergeFunction) {
    ...
    /**
     * The component property to write the value to.
     * @type {string}
     */
    this.property = null;
 ...
 * @param targetValue
 */
Transition.prototype.updateTargetValue = function(targetValue) {
    var wasActive = this.isActive();

    if (!Utils.isNumber(targetValue)) {
        throw new TypeError("Not a number");
    }

    this.targetValue = targetValue;

    this.startValue = this.lastResultValue;
